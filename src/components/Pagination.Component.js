        ...
        return (
            <ul className="pagination">
                <li className={`page-item ${pager.currentPage == 1 ? 'disabled' : ''}`}>
                    ...
                    <Link className="page-link" to={{pathname:`/keyword/keywords`,search:`?page=1`}}>First</Link>
                </li>
                <li className={`page-item ${pager.currentPage == 1 ? 'disabled' : ''}`}>
                    {/* <Link className="page-link" to={`/keyword/keywords/${parseInt(pager.currentPage) - 1}`}>Previous</Link> */}
                    <Link className="page-link" to={{pathname:`/keyword/keywords`,search:`?page=${parseInt(pager.currentPage) - 1}`}}>Previous</Link>
                </li>
                {pager.pages.map((page, index) =>
                    <li key={index} className={`page-item ${pager.currentPage == page ? 'active' : ''}`}>
                        ...
                        <Link className="page-link" to={{pathname:`/keyword/keywords`,search:`?page=${page}`}}>{page}</Link>
                ...
                <li className={`page-item ${pager.currentPage == pager.totalPages ? 'disabled' : ''}`}>
                    ...
                    <Link className="page-link" to={{pathname:`/keyword/keywords`,search:`?page=${parseInt(pager.currentPage) + 1}`}}>Next</Link>
                </li>
                <li className={`page-item ${pager.currentPage == pager.totalPages ? 'disabled' : ''}` }>
                    {/* <Link className="page-link" to={`/keyword/keywords/${pager.totalPages}`}>Last</Link> */}
                    <Link className="page-link" to={{pathname:`/keyword/keywords`,search:`?page=${pager.totalPages}`}}>Last</Link>
                </li>
            </ul>
        )
    }
